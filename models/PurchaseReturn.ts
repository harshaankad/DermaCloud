...
const PurchaseReturnSchema = new Schema<IPurchaseReturn>(
  {
    ...
    originalPurchaseId: { type: Schema.Types.ObjectId, ref: "Purchase" },
...
PurchaseReturnSchema.index({ clinicId: 1, invoiceDate: -1 });

const PurchaseReturn: Model<IPurchaseReturn> =
