              ...
              <div className="divide-y divide-gray-100">
                {patients.map((patient) => (
                  <div key={patient._id} className="group px-5 py-4 hover:bg-gray-50/70 transition-colors flex items-center gap-4 md:grid md:grid-cols-12 md:gap-4">
                    ...
                    <Link href={`/clinic/patients/${patient._id}`} className="flex items-center gap-3 flex-1 min-w-0 md:col-span-3">
                    ...
                    <Link href={`/clinic/patients/${patient._id}`} className="flex-shrink-0 md:hidden">
