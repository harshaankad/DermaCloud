  ...
  const handleAddPatient = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setSearchInput("");
        setSearchQuery("");
        setTimeout(() => router.push(`/clinic/patients/${data.data.patient._id}`), 800);
      } else {
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="hidden md:grid md:grid-cols-12 gap-4 px-5 py-3 bg-gray-50 border-b text-xs font-semibold text-gray-500 uppercase tracking-wide">
                ...
                <div className="col-span-2 pl-3">ID</div>
                <div className="col-span-2 text-center -ml-8">Age / Gender</div>
              ...
              <div className="divide-y divide-gray-100">
                {patients.map((patient) => (
                  <Link key={patient._id} href={`/clinic/patients/${patient._id}`} className="group block px-5 py-4 hover:bg-gray-50/70 transition-colors cursor-pointer">
                    <div className="flex items-center gap-4 md:grid md:grid-cols-12 md:gap-4">
                      {/* Patient name + avatar */}
                      <div className="flex items-center gap-3 flex-1 min-w-0 md:col-span-4">
                      ...
                      {/* Age / Gender */}
                      <div className="hidden md:flex md:col-span-2 items-center justify-center gap-2 -ml-8">
