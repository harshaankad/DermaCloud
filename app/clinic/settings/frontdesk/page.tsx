...
export default function FrontdeskSettingsPage() {
  ...
  const defaultPermissions = { appointments: true, patients: true, pharmacy: true, sales: true, reports: false };
  ...
  const handleAddStaff = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/tier2/frontdesk", {
        ...
        body: JSON.stringify({ ...formData, permissions: defaultPermissions }),
      });
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-teal-700 mt-0.5">
                Staff log in at <span className="font-mono bg-teal-100 px-1.5 py-0.5 rounded text-teal-800 text-xs">/frontdesk/login</span> using the credentials you create here. They get access to Appointments, Patients, Pharmacy, and Sales by default.
              </p>
            </div>
          </div>
        </div>
