                  ...
                  return (
                    <>
                      ...
                      {saleForm.isInterstate
                        ...
                        : <>
                            <div className="flex justify-between text-xs"><span className="text-gray-400">CGST (incl.)</span><span className="text-blue-500">₹{cgst.toFixed(2)}</span></div>
                            <div className="flex justify-between text-xs"><span className="text-gray-400">SGST (incl.)</span><span className="text-blue-500">₹{sgst.toFixed(2)}</span></div>
                          </>
                      }
