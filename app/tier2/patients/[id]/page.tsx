        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-6">
          ...
          <div className="p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {/* Start Visit Buttons */}
              <Link href={`/tier2/visit/dermatology?patientId=${patient._id}${appointmentId ? `&appointmentId=${appointmentId}` : ""}`}>
              ...
              <Link href={`/tier2/visit/cosmetology?patientId=${patient._id}${appointmentId ? `&appointmentId=${appointmentId}` : ""}`}>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          {visits.length === 0 ? (
            ...
            <div className="divide-y divide-gray-100">
              {visits.map((visit) => (
                <Link key={visit._id} href={visit.visitType === "cosmetology" ? `/tier2/consultation/cosmetology/${visit._id}` : `/tier2/consultation/${visit._id}`}>
